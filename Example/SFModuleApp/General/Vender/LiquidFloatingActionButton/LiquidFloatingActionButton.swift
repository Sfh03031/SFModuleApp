...
@objc public protocol LiquidFloatingActionButtonDelegate {
    // selected method
    @objc optional func liquidFloatingActionButton(_ LFAButton: LiquidFloatingActionButton, didSelectItemAtIndex index: Int)
	@objc optional func liquidFloatingActionButtonWillOpenDrawer(_ LFAButton: LiquidFloatingActionButton)
	@objc optional func liquidFloatingActionButtonWillCloseDrawer(_ LFAButton: LiquidFloatingActionButton)
}
