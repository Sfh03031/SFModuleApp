...
class MatchColorVC: BaseCollectionViewController {
    
    var defLayout: FlowLayoutType = .twice
    var dataList: [MatchColorModel] = []
    ...
    override func viewDidLoad() {
        ...
        self.collectionView?.register(MatchColorCell.self, forCellWithReuseIdentifier: String(describing: MatchColorCell.self))
        self.collectionView?.register(MatchColorCell.self, forCellWithReuseIdentifier: "MatchColorCellTwice")
        ...
        for (_, item) in matchColor.enumerated() {
            let dic = item as [String: Any]
            let model = JSONDeserializer<MatchColorModel>.deserializeFrom(dict: dic)
...
extension MatchColorVC: UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if self.defLayout == .single {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: String(describing: MatchColorCell.self), for: indexPath) as? MatchColorCell
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "MatchColorCellTwice", for: indexPath) as? MatchColorCell
