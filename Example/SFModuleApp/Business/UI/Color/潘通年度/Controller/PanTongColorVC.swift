...
class PanTongColorVC: BaseCollectionViewController {
    
    var defLayout: FlowLayoutType = .twice
    var dataList: [PanTongColorModel] = []
    ...
    override func viewDidLoad() {
        ...
        self.collectionView?.register(PanTongColorCell.self, forCellWithReuseIdentifier: String(describing: PanTongColorCell.self))
        ...
        for (_, item) in panTongColor.enumerated() {
            let dic = item as [String: Any]
            let model = JSONDeserializer<PanTongColorModel>.deserializeFrom(dict: dic)
...
extension PanTongColorVC: UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: String(describing: PanTongColorCell.self), for: indexPath) as? PanTongColorCell
