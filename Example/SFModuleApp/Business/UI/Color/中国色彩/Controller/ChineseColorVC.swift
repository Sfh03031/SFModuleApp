...
class ChineseColorVC: BaseCollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        for (_, item) in chineseColor.enumerated() {
...
extension ChineseColorVC: UICollectionViewDelegateFlowLayout {
