...
class PortraitTileGridViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.title = "Portrait Tile Grid Layout"
        configureHierarchy()
        configureDataSource()
    }
}
...
extension PortraitTileGridViewController {
    ...
    func createLayout() -> UICollectionViewLayout {
        let layout = UICollectionViewCompositionalLayout {
            ...
            let centerGroup = NSCollectionLayoutGroup.vertical(layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.33),
                                                                                                  heightDimension: .fractionalHeight(1.0)),
