...
class BouncyLayoutVC: BaseViewController {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        view.register(BouncyCell.self, forCellWithReuseIdentifier: BouncyCell.reuseIdentifier)
...
extension BouncyLayoutVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        return collectionView.dequeueReusableCell(withReuseIdentifier: BouncyCell.reuseIdentifier, for: indexPath)
    }
    
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        guard let cell = cell as? BouncyCell else { return }
...
extension BouncyLayoutVC: UICollectionViewDelegateFlowLayout {
