...
class NotificationBannerVC: UIViewController {
...
extension NotificationBannerVC: NotificationBannerDelegate {
...
extension NotificationBannerVC: ExampleViewDelegate {
    ...
    internal func basicNotificationCellSelected(at index: Int) {
        ...
        case 4:
            ...
            let banner = NotificationBanner(title: "Custom Warning Notification",
                                            ...
                                            style: .warning,
                                            colors: UIColor(red:1.00, green:0.66, blue:0.16, alpha:1.00) as? BannerColorsProtocol)
            banner.delegate = self
