...
// FIXME: 在TARGETS -> Signing & Capabilities -> Backgound Modes 勾选【Audio,AirPlay,and Picture in Picture】
// FIXME: 在进入后台方法里调用 `SFBackgroundTaskManager.shared.start()`, 进入前台方法里调用 `SFBackgroundTaskManager.shared.stop()`
