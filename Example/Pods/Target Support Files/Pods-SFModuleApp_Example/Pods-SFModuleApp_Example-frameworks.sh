...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LottieService/LottieService.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SFCircleProgressView/SFCircleProgressView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SFFocusViewLayout/SFFocusViewLayout.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SFModuleApp/SFModuleApp.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SFNetworkManager/SFNetworkManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SFNetworkMonitor/SFNetworkMonitor.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SFServiceKit/SFServiceKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SSZipArchive/SSZipArchive.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SVProgressHUD/SVProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ScreenRotator/ScreenRotator.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Splitflap/Splitflap.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Twinkle/Twinkle.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YZHeaderScaleImage/YZHeaderScaleImage.framework"
